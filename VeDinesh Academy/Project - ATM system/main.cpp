...
public:                               // public member functions
    ...
    //getName function is returning the use's Name
    string getName()
    {
        return name;
    }

    //getPIN function is returning the use's PIN
    int getPIN()
    {
        return PIN;
    }
    ...
    void setMobile(string mob_prev, string mob_new)
    {
        ...
        else {                              // doesn't update if old mobile no, dosn't matches
    ...
    void cashWithDraw(int amount_a)
    {
        ...
        else
        {
            ...
            _getch();                            // getch is to hold the screen ( until user prees any key )
        }
    }
};
...
int main()
{
    int choice = 0, enterPIN;                    // enter PIN and enterAccountNo. ---> user authentication
        ...
        if ((enterAccountNo == user1.getAccountNo()) && (enterPIN == user1.getPIN())) {
            do {
                ...
                case 2:                           // if user presses 2
                    ...
                    cin >> amount;
                    user1.cashWithDraw(amount);   // call cashWithdraw function // passing the withdraw amount
                    break;
